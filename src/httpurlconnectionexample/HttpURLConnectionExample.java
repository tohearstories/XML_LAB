...
public class HttpURLConnectionExample {
	...
	private void sendGet() throws Exception {
                ...
                System.out.print("input tuid: ");
                String id = qwerty.nextLine();
            
		String url = "http://129.32.92.49:8080/xml_lab/getgrade?xml=<tuid>"+id+"6000</tuid>";
		...
		System.out.println(response.toString());
                ...
                //int timestamp1 = Integer.parseInt(grade);
